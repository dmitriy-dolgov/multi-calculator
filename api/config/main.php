...
return [
    'id' => 'multipurpose-calculator-creator-app-api',
    'name' => 'Pizza Maya',
        ...
        'log' => [
            ...
            'targets' => [
                ...
                [
                    ...
                    'logFile' => '@runtime/logs/sse-order-api.log',
                    'exportInterval' => 1,
    ...
    'modules' => [
        ...
        'setup' => [
            'class' => 'api\modules\setup\Module',
        ],
        'admin' => [
        ...
        'user' => [
            ...
            'layout' => '@api/modules/setup/views/layouts/main',

            'controllerMap' => [
                'settings' => 'api\modules\setup\controllers\SettingsController',
                'security' => [
                    'class' => \Da\User\Controller\SecurityController::class,
                    //'class' => 'app\controllers\SecurityController',
                    'layout' => '@api/views/layouts/registration',
                ],
                'registration' => [
...
//                        }
                ...
                'admin' => [
                    ...
                    //'class' => \api\modules\admin\controllers\RegistrationController::class,
                    'layout' => '@api/modules/admin/views/layouts/main',
                ],
                'role' => [
