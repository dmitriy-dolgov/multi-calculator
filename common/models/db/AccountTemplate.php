 ...
 */
class AccountTemplate extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return AccountTemplateQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new AccountTemplateQuery(get_called_class());
    }
}
